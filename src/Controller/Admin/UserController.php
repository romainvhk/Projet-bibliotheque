...
class UserController extends AbstractController
{
    ...
    public function password(Request $request, User $user, UserRepository $userRepository, UserPasswordHasherInterface $hasher
    ): Response
    {
        ...
        return $this->renderForm('admin/user/password.html.twig', [
            'user' => $user,
            'form' => $form,
        ]);
    }
